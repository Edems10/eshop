...
{
    public class SecurityIdentityApplicationServices : ISecurityApplicationServices
    {
        UserManager<User> userManager;
        SignInManager<User> signInManager;

        public SecurityIdentityApplicationServices(UserManager<User> userManager, SignInManager<User> signInManager)
        {
