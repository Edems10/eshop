...
namespace eshop
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<ISecurityApplicationServices, SecurityIdentityApplicationServices>();

            //!!!!!jen AddDistributedMemoryCache a AddSession je potřeba doplnit!!!!!
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            //!!!!!jen tento UseSession je potřeba doplnit!!!!!
            app.UseSession();
